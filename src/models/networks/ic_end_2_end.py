...
class ICEnd2EndNetwork(nn.Module):
    ...
    def forward(self, inputs, meta_data):
        ...
        SR_inputs_1 = self.super_resolution_model(inputs_1, meta_data_1)
        preds_1 = self.regression_model(SR_inputs_1, meta_data_1)

        SR_inputs_2 = self.super_resolution_model(inputs_2, meta_data_2)
        preds_2 = self.regression_model(SR_inputs_2, meta_data_2)
